...
def validation_Worms_Itis_fonction(data, value):
    ...
    liste_noms_pre_modif, liste_noms, liste_noms_sans_suffix, liste_noms_sp, liste_noms_sp_point, liste_noms_spp_point = function_suffix_removal(data_valid_scientific_name)
    ...
    async def info_noms(index, nom):
        async with httpx.AsyncClient(timeout = timeout) as client:
            list_of_list = function_add_suffix(nom, liste_noms_sans_suffix, liste_noms_sp, liste_noms_sp_point, liste_noms_spp_point)
    ...
    if value == 'names_taxons_ids':
        return names_taxons_ids_tables(data_valid_scientific_name, data_cross_validation)
