...
def occurrenceid_fonction(data):
    ...
    liste_occurrenceid = ["Le nombre de valeurs uniques trouvées dans la colonne 'occurrenceID' est présenté dans le tableau.",
    ...
    return html.Div([
        ...
        data=tableau_occurrenceid.to_dict('records'),id={'type': 'tableau_occurrenceid'},
        columns=[{'name': ["Validation de données / Data validation: 'occurrenceid'", i], 'id': i} for i in tableau_occurrenceid.columns],
