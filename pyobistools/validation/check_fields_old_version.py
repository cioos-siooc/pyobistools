...
def check_fields_old_version(data, level='error', analysis_type='occurrence_core', accepted_name_usage_id_check=False):
    ...
    return check_fields_generic_old_version(data, level, dataframe_column_key, accepted_name_usage_id_check)


def check_fields_generic_old_version(data, level='error', dataframe_column_key=None, accepted_name_usage_id_check=False):
    NaN = np.nan
