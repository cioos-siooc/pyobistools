...
def function_suffix_removal(data_valid_nom_scientifique):
    ...
    return liste_noms_pre_modif, liste_noms, liste_noms_sans_suffix, liste_noms_sp, liste_noms_sp_point, liste_noms_spp_point


def function_add_suffix(nom, liste_noms_sans_suffix, liste_noms_sp, liste_noms_sp_point, liste_noms_spp_point):
    list_of_list = {}
    nom_recomposed = nom
